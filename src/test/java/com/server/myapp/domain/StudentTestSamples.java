...
public class StudentTestSamples {
    ...
    public static Student getStudentSample1() {
        return new Student().id(1L).studentId("studentId1").fullName("fullName1").phone("phone1").address("address1");
    }

    public static Student getStudentSample2() {
        return new Student().id(2L).studentId("studentId2").fullName("fullName2").phone("phone2").address("address2");
    }
