...
export const StudentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="serverTluContactApp.student.delete.question">
        <Translate contentKey="serverTluContactApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
