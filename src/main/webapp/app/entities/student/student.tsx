  ...
  return (
    <div>
      <h2 id="student-heading" data-cy="StudentHeading">
        <Translate contentKey="serverTluContactApp.student.home.title">Students</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="serverTluContactApp.student.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/student/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="serverTluContactApp.student.home.createLabel">Create new Student</Translate>
          </Link>
        </div>
      </h2>
        ...
        {studentList && studentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="serverTluContactApp.student.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="serverTluContactApp.student.email">Email</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="serverTluContactApp.student.unit">Unit</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="serverTluContactApp.student.home.notFound">No Students found</Translate>
            </div>
          )
        )}
      </div>
